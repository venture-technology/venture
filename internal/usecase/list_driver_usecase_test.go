...
func TestListDriverUsecase_ListDriver(t *testing.T) {
	...
	t.Run("if repository returns error", func(t *testing.T) {
		...
		repository.On("FindAllByCnpj", mock.Anything).Return([]entity.Partner{}, errors.New("database error"))
	...
	t.Run("if list returns sucess", func(t *testing.T) {
		...
		repository.On("FindAllByCnpj", mock.Anything).Return([]entity.Partner{}, nil)
