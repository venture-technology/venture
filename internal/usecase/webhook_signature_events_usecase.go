...
type WebhookSignatureEventsUseCase struct {
	repositories *persistence.PostgresRepositories
	logger       contracts.Logger
	adapters     adapters.Adapters
}

func NewWebhookSignatureEventsUseCase(
	repositories *persistence.PostgresRepositories,
	logger contracts.Logger,
	adapters adapters.Adapters,
) *WebhookSignatureEventsUseCase {
	return &WebhookSignatureEventsUseCase{
...
func (weuc *WebhookSignatureEventsUseCase) Execute(
	httpCtx *gin.Context,
