...
// Cancel provides a mock function with given fields: uuid
func (_m *TempContractRepository) Cancel(uuid string) error {
	ret := _m.Called(uuid)
...
// Expire provides a mock function with given fields: uuid
func (_m *TempContractRepository) Expire(uuid string) error {
	ret := _m.Called(uuid)
...
// Update provides a mock function with given fields: uuid, attrs
func (_m *TempContractRepository) Update(uuid string, attrs map[string]interface{}) error {
	ret := _m.Called(uuid, attrs)
