...
func (_m *IChildRepository) Create(child *entity.Child) error {
	ret := _m.Called(child)
...
func (_m *IChildRepository) Delete(rg *string) error {
	ret := _m.Called(rg)
...
func (_m *IChildRepository) FindAll(cpf *string) ([]entity.Child, error) {
	ret := _m.Called(cpf)
...
func (_m *IChildRepository) Get(rg *string) (*entity.Child, error) {
	ret := _m.Called(rg)
...
func (_m *IChildRepository) Update(rg string, attributes map[string]interface{}) error {
