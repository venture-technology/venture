...
// ResponsiblesibleRepository is an autogenerated mock type for the ResponsiblesibleRepository type
type ResponsiblesibleRepository struct {
	mock.Mock
}

// Auth provides a mock function with given fields: responsible
func (_m *ResponsiblesibleRepository) Auth(responsible *entity.Responsible) (*entity.Responsible, error) {
...
func (_m *ResponsiblesibleRepository) Create(responsible *entity.Responsible) error {
	ret := _m.Called(responsible)
...
func (_m *ResponsiblesibleRepository) Delete(cpf string) error {
	ret := _m.Called(cpf)
...
func (_m *ResponsiblesibleRepository) FindByEmail(email string) (*entity.Responsible, error) {
	ret := _m.Called(email)
...
func (_m *ResponsiblesibleRepository) Get(cpf string) (*entity.Responsible, error) {
	ret := _m.Called(cpf)
...
func (_m *ResponsiblesibleRepository) SaveCard(cpf string, cardToken string, paymentMethodId string) error {
...
func (_m *ResponsiblesibleRepository) Update(cpf string, attributes map[string]interface{}) error {
...
// NewResponsiblesibleRepository creates a new instance of ResponsiblesibleRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewResponsiblesibleRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *ResponsiblesibleRepository {
	mock := &ResponsiblesibleRepository{}
	mock.Mock.Test(t)
