...
// PNG provides a mock function with given fields:
...
// SaveWithType provides a mock function with given fields: path, filaneme, file, contentType
func (_m *S3Iface) SaveWithType(path string, filaneme string, file []byte, contentType string) (string, error) {
	ret := _m.Called(path, filaneme, file, contentType)
