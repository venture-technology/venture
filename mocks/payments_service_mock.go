...
func (_m *PaymentsService) CalculateRemainingValueSubscription(invoices map[string]entity.InvoiceInfo, amount int64) int64 {
	...
	var r0 int64
	if rf, ok := ret.Get(0).(func(map[string]entity.InvoiceInfo, int64) int64); ok {
...
func (_m *PaymentsService) CreatePrice(stripeProductID string, amount int64) (*stripe.Price, error) {
	...
	var r0 *stripe.Price
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int64) (*stripe.Price, error)); ok {
		return rf(stripeProductID, amount)
	}
	if rf, ok := ret.Get(0).(func(string, int64) *stripe.Price); ok {
